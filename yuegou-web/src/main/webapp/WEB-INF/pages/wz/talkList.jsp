            ...
            <div style="float: left;width: 1200px;overflow: hidden;display: block;">
                <div class="menu">
                    <div class="wrapper clearfix">
                        <dl class="menu-movie">
                            <dd>
                                <a href="<%=basePath%>homepage/talks?type=99" title="随便说说">随便说说</a>
                            </dd>
                        </dl>
                    </div>
                </div>
                    ...
                    <c:forEach items="${results.list}" var="item">
                        <div id="post-97" class="post clearfix">
                            <h3 class="entry-title">
                                <a href="<%=basePath%>homepage/talkId/${item.id}" style="color: #999;" title="${item.title}" target="_blank">${item.title}</a>
                            </h3>
                            <div class="entry-meta">
                                <span class="">最后更新：<fmt:formatDate value="${item.createTime}" pattern="yyyy年MM月dd日"/></span>
                            </div>
                        </div>
                    </c:forEach>
