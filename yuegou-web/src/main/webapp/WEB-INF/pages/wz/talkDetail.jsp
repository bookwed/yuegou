                ...
                <div style="float: left;width: 1200px;overflow: hidden;display: block;">
                    ...
                    <div id="detail-001" class="entry" style="padding-bottom: 10px;">
                        ...
                        <div class="entry-meta clearfix">
                            <span class="meta-date">发布时间：<fmt:formatDate value="${result.createTime}" pattern="yyyy-MM-dd"/></span>
                        </div>
                        <div class="entry-content clearfix">
                            <%--<h3>影评</h3>--%>
                            <div id="movieComment" style="float:left;width:900px;word-wrap: break-word;overflow:auto; ">
                                ${result.content}
                            </div>
                        </div>
                    </div>
